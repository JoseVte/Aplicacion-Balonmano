...
public class JugadorDefensaActor extends JugadorAbstractActor {

	public JugadorDefensaActor(int num, float x, float y) {
		
		super(num, x, y, Settings.skin+"/Campo/jugador_defensa.png");
	...
	public void draw(Batch batch, float parentAlpha) {
		...
		super.fuenteNumeros.draw(batch, ""+getNumJugador(), getX() + getWidth()/3, getY()+ getHeight()/2 + 8);
